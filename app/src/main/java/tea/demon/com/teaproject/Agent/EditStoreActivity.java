...
public class EditStoreActivity extends AppCompatActivity implements IView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TitleUtil.setToolBar(this, getString(R.string.editStoreInfo));
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 0x001) {
                    ...
                    startActivity(new Intent(EditStoreActivity.this, AgentActivity.class));
                    finish();
                }
            }
        };
    ...
    private void initView() {
        ...
        etDes.setText(store.getDescription());
    }
    ...
    public void onViewClicked() {
        ...
        if (TextUtils.isEmpty(name) || TextUtils.isEmpty(phone) || TextUtils.isEmpty(address) || TextUtils.isEmpty(des)) {
            ...
            map.put(Constant.STORE_ID, store.getStore_id() + "");
